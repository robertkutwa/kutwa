# encoding: utf-8
# module _contextvars
# from /usr/lib/python3.12/lib-dynload/_contextvars.cpython-312-x86_64-linux-gnu.so
# by generator 1.147
""" Context Variables """
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7eeffd44d9a0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_contextvars', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7eeffd44d9a0>, origin='/usr/lib/python3.12/lib-dynload/_contextvars.cpython-312-x86_64-linux-gnu.so')"
