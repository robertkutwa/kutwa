# encoding: utf-8
# module ossaudiodev
# from /usr/lib/python3.12/lib-dynload/ossaudiodev.cpython-312-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7eeffd44c3e0>'

__spec__ = None # (!) real value is "ModuleSpec(name='ossaudiodev', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7eeffd44c3e0>, origin='/usr/lib/python3.12/lib-dynload/ossaudiodev.cpython-312-x86_64-linux-gnu.so')"
